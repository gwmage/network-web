...
import ReservationManagement from './components/ReservationManagement'; // Import the component
  ...
  return (
    <Router>
      <div>
        ...
        <Routes>
          {/* ... other routes */}
           <Route path="/admin/reservations" element={<ReservationManagement />} /> {/* Add the route */}
